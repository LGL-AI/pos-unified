const VERSION='lotus-qr-static-v2.1.1-20260924';
...
self.addEventListener('fetch',event=>{
 const req=event.request;if(req.method!=='GET')return;const u=new URL(req.url);if(u.origin!==self.location.origin||u.pathname.startsWith('/api/')||u.pathname.startsWith('/kitchen/')||u.pathname.startsWith('/staff/')||u.pathname.includes('payment'))return;
